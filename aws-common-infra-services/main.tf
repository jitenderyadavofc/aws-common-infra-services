...
#   depends_on = [module.len-aws-fw-policy-mod]
...
#   tag_names      = var.tags
#   rule_group_details = module.len-aws-fw-rule-group-mod.rule_group_output.arn
...
# output "fw_rule_group-output" {
#   value = module.len-aws-fw-rule-group-mod.rule_group_output.arn
# }
